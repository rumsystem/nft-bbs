...
export class init1662003117066 implements MigrationInterface {
  name = 'init1662003117066';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE "comments" ("id" SERIAL NOT NULL, "trxId" character varying NOT NULL, "groupId" character varying NOT NULL, "content" character varying NOT NULL, "objectId" character varying NOT NULL, "threadId" character varying NOT NULL, "replyId" character varying NOT NULL, "userAddress" character varying NOT NULL, "storage" character varying NOT NULL, "timestamp" TIMESTAMP NOT NULL, "commentCount" integer NOT NULL, "likeCount" integer NOT NULL, "dislikeCount" integer NOT NULL, "hotCount" integer NOT NULL, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))');
    ...
    await queryRunner.query('CREATE TABLE "groupstatus" ("groupId" character varying NOT NULL, "startTrx" character varying NOT NULL DEFAULT \'\', CONSTRAINT "PK_3f571bf581aab90549859c86829" PRIMARY KEY ("groupId"))');
  }
