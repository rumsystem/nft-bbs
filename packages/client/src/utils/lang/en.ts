...
export const content: Content = {
  ...
  comment: {
    ...
    clearText: 'Clear',
    submit: 'Reply',
    commentInputPlaceholder: 'Type your comment here…',
    replyCount: (n: number) => `${n} replies`,
    waitForSync: 'Please wait for replies syncing',
  },
  profile: {
    heldedNFTs: (self: boolean) => `${self ? 'Mine' : 'Their'} NFT`,
    nftTransfer: 'NFT Trade/Exchange',
    editProfile: 'Edit porfile',
